...
<body>
    ...
    <div class="card text-bg-dark">
        <img src="{{asset('buku.jpg')}}" class="card-img" alt="...">
        <div class="card-img-overlay">
        <div class="position-absolute top-50 start-50 translate-middle">
                <div class="d-flex" style="margin-left: 5rem;">
                    <p class="card-text">Selamat Datang Di MYPERPUS</p>
                </div>
                       <p class="card-text">Kami Menyediakan Banyak Sekali Buku Yang Menarik</p>
        </div>
