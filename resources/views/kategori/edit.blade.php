        ...
        <div class="container p-5">
            ...
            <form action="{{ route('kategori.update',$data->id) }}" method="POST">
                ...
                <div class="sm:col-span-4 mb-3">
                    ...
                    <div class="mt-2">
                        <input type="text" name="nama_kategori" id="title" value="{{ $data->nama_kategori }}" class="block w-full p-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
